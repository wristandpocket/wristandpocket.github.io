...
Наступний крок — зробити стан улюбленця простішим для читання, перевірити, що годування, миття й тренування не блокують інтерфейс, підтвердити збереження й поведінку без мережі та підготувати скриншоти з поточної версії.

Це не анонс фінального релізу. Це нотатка про поступову роботу над невеликою, зрозумілою тестовою версією Feed Me, Loser! — один цикл за раз.
