...
*   [assets/js/script.js](file:///c:/Users/igors/Documents/GitHub/wristandpocket.github.io/assets/js/script.js) parses the `data-tags` attribute on `.news-card` items and filters them instantly on click.
...
All builds are handled automatically in the cloud via GitHub Actions workflow [.github/workflows/jekyll.yml](file:///c:/Users/igors/Documents/GitHub/wristandpocket.github.io/.github/workflows/jekyll.yml).
...
*   **Implementation:** Add the path/regex to `--ignore-urls` in [.github/workflows/jekyll.yml](file:///c:/Users/igors/Documents/GitHub/wristandpocket.github.io/.github/workflows/jekyll.yml) (e.g. `,/assets\/images\//`).
